...
const pkgData = {
  weddings: [
    {
      n: '$8,500',
      note: 'up to 50 guests',
      items: [
        'Single space of your choice',
        '6-hour rental window',
        'In-house catering team',
        'Day-Of Coordinator',
        'One full-service bar',
      ],
    },
    {
      n: '$14,500',
      note: 'up to 120 guests',
      items: [
        'Two spaces (ceremony + reception)',
        '10-hour rental window',
        'Full catering package',
        'Day-Of Coordinator',
        'Both full-service bars',
        'Getting ready suite',
      ],
    },
    {
      n: '$22,000',
      note: 'up to 200 guests',
      items: [
        'All six spaces — full buyout',
